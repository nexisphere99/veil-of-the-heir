...
function goTo(passageName) {
  ...
  <tbody>
    <tr>
      <td><img src="images/ingredients/moonpetal_extract.png" alt="Moonpetal Extract" width="50"></td>
      <td>Moonpetal Extract</td>
      <td>8</td>
      <td>tsp</td>
      <td>Silvery nectar harvested from a rare flower that blooms only under full moons.</td>
    ...
    <tr>
      <td><img src="images/ingredients/velmorian_honey.png" alt="Velmorian Honey" width="50"></td>
      <td>Velmorian Honey</td>
      <td>30</td>
      <td>ml</td>
      <td>Golden sap from enchanted forest beehives, rich with dream pollen.</td>
      <td>Smooths transitional phases by harmonizing bodily changes. Adds sweetness—both in scent and aura—to the emerging form. Often a base for softening potions.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/glowleaf_powder.png" alt="Glowleaf Powder" width="50"></td>
      <td>Glowleaf Powder</td>
      <td>3</td>
      <td>pinch</td>
      <td>Crushed leaves of the glowing duskplant, harvested at twilight.</td>
      <td>A potent magical catalyst, essential for activating and stabilizing anatomical restructuring. Common in core transformation brews.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/starblossom_pollen.png" alt="Starblossom Pollen" width="50"></td>
      <td>Starblossom Pollen</td>
      <td>5</td>
      <td>scoop</td>
      <td>Pollen harvested from starlit flowers that only bloom during solstice nights.</td>
      <td>Encourages growth of soft feminine features like hips, breasts, and hair. Must be stabilized to prevent excessive or lopsided development.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/crimsondew_drops.png" alt="Crimsondew Drops" width="50"></td>
      <td>Crimsondew Drops</td>
      <td>4</td>
      <td>ml</td>
      <td>Collected from dawn-succulents kissed by the first light of morning.</td>
      <td>Sharpen sensual and erogenous sensitivity. Often used for erotic transformation potions.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/feylace_petal.png" alt="Feylace Petal" width="50"></td>
      <td>Feylace Petal</td>
      <td>3</td>
      <td>petal</td>
      <td>An iridescent petal gathered near fae-realm crossings.</td>
      <td>Adds otherworldly beauty and charm to facial and chest features. Often used in glamour or beautification brews.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/dragonmoss_resin.png" alt="Dragonmoss Resin" width="50"></td>
      <td>Dragonmoss Resin</td>
      <td>5</td>
      <td>drop</td>
      <td>Thick green resin excreted by magical dragonmoss on volcanic stone.</td>
      <td>Strengthens tissues during transformation. Commonly used in masculinity-enhancing potions or to reinforce structural changes.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/seraphmilk.png" alt="Seraphmilk" width="50"></td>
      <td>Seraphmilk</td>
      <td>15</td>
      <td>ml</td>
      <td>Milky white substance collected from celestial-blessed livestock.</td>
      <td>Refines and purifies transformational effects. Adds divine softness and perfection to final form. Potent in high doses.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/frostvine_elixir.png" alt="Frostvine Elixir" width="50"></td>
      <td>Frostvine Elixir</td>
      <td>10</td>
      <td>ml</td>
      <td>A blue, icy liquid distilled from arctic frostvines.</td>
      <td>Temporarily halts softening and tissue fluidity, restoring structure and firmness. Used to correct over-softening during transformation.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/ashfern_flakes.png" alt="Ashfern Flakes" width="50"></td>
      <td>Ashfern Flakes</td>
      <td>4</td>
      <td>g</td>
      <td>Powdered ash from the burnt fronds of magical ferns.</td>
      <td>Suppresses magical transformation. Frequently used in potions to halt or reverse undesired developments.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/softroot_essence.png" alt="Softroot Essence" width="50"></td>
      <td>Softroot Essence</td>
      <td>7</td>
      <td>drop</td>
      <td>Distilled from the softroot plant found in fae-swamps.</td>
      <td>Increases malleability and flexibility in bodily structure. Prepares tissues for reshaping.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/sorrowseed_oil.png" alt="Sorrowseed Oil" width="50"></td>
      <td>Sorrowseed Oil</td>
      <td>6</td>
      <td>tsp</td>
      <td>Oily resin extracted from sorrowseed pods, found only near ancient grave trees.</td>
      <td>Alters emotional profile, adding empathy and vulnerability. Can be used to soften or suppress unwanted over-sensitivity.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/nightshade_bloom.png" alt="Nightshade Bloom" width="50"></td>
      <td>Nightshade Bloom</td>
      <td>3</td>
      <td>petal</td>
      <td>Petals from the dangerous yet beautiful Nightshade plant, gathered at midnight.</td>
      <td>Heightens physical sensitivity. Can reverse some feminine refinements when blended into masculine reversal brews.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/thornberry_juice.png" alt="Thornberry Juice" width="50"></td>
      <td>Thornberry Juice</td>
      <td>20</td>
      <td>ml</td>
      <td>Juice of thornberries that sting the skin on contact.</td>
      <td>Restores toughness and masculinity. Strong reversal agent for softened or feminized traits.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/lilywhisper_nectar.png" alt="Lilywhisper Nectar" width="50"></td>
      <td>Lilywhisper Nectar</td>
      <td>2</td>
      <td>ml</td>
      <td>Collected from white lilies blessed by wind spirits.</td>
      <td>Induces grace and lightness in physical movement. Used for beautifying legs, gait, and posture.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/vinesilk_essence.png" alt="Vinesilk Essence" width="50"></td>
      <td>Vinesilk Essence</td>
      <td>2</td>
      <td>ml</td>
      <td>Silky extract from flowering vines used in nature-binding spells.</td>
      <td>Smooths and slims limbs and textures. Adds elegance and softness to movement and form.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/crimsonroot_dust.png" alt="Crimsonroot Dust" width="50"></td>
      <td>Crimsonroot Dust</td>
      <td>10</td>
      <td>g</td>
      <td>Powdered root of the Crimsonroot, found near leyline convergences.</td>
      <td>Stabilizes and locks in transformation. Used to finalize permanent changes. Can also enhance femininity subtly when brewed with glowleaf.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/velvetgrove_essence.png" alt="Velvetgrove Essence" width="50"></td>
      <td>Velvetgrove Essence</td>
      <td>2</td>
      <td>tsp</td>
      <td>Essence of mosses that grow on trees touched by dreamlight.</td>
      <td>Deeply softens skin. Used for surface refinement of lips, hands, and thighs.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/frostleaf_crystals.png" alt="Frostleaf Crystals" width="50"></td>
      <td>Frostleaf Crystals</td>
      <td>4</td>
      <td>tsp</td>
      <td>Formed from the condensation on magical frostleaves.</td>
      <td>Coarsens and thickens skin. Used in ruggedification brews or to suppress softness in muscle and face.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/eversilk_thread.png" alt="Eversilk Thread" width="50"></td>
      <td>Eversilk Thread</td>
      <td>3</td>
      <td>cm</td>
      <td>Woven from enchanted silkworms bred in elven groves.</td>
      <td>Facilitates internal reshaping, especially vaginal formation. Adds flexibility and durability to magical structures.</td>
    </tr>
    <tr>
      <td><img src="images/ingredients/nullroot_dust.png" alt="Nullroot Dust" width="50"></td>
      <td>Nullroot Dust</td>
      <td>4</td>
      <td>tsp</td>
      <td>Ground-up Nullroot, which naturally suppresses magical energy.</td>
      <td>Freezes or reverses transformation completely. Used only in emergencies or permanent rejection of transformation pathways.</td>
    </tr>
  </tbody>
</table>
